    ...
    <section id="projects" className="py-24 md:py-32 bg-white relative optimize-render">
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-8">
          ...
          <div className="flex flex-wrap gap-2 bg-secondaryBg p-1.5 rounded-3xl border border-black/[0.04]">
            {projects.map(p => (
              <button
                key={p.id}
                onClick={() => {
                ...
                className={`px-5 py-2.5 rounded-full text-xs font-semibold uppercase tracking-wider transition-all duration-300 min-h-[44px] flex items-center justify-center ${
                  activeTab === p.id
          ...
          >
            ...
            <div className="lg:col-span-6 space-y-8 text-left">
              ...
              <div className="grid grid-cols-3 gap-4 bg-secondaryBg p-5 rounded-2xl border border-black/[0.04] shadow-sm">
                {activeProject.metrics.map(m => (
                  <div key={m.label} className="flex flex-col">
                    <span className="text-[10px] text-dark/60 uppercase font-semibold">{m.label}</span>
                ...
                <div className="flex gap-4 border-b border-black/[0.06] pb-2">
                  {(['challenge', 'solution', 'results'] as const).map(tab => (
                    <button
                      ...
                      className={`text-xs font-bold uppercase tracking-wider pb-2 relative transition-all min-h-[44px] flex items-center ${
                        activeSubTab === tab ? 'text-dark font-extrabold' : 'text-dark/60 hover:text-dark'
                      }`}
                    >
                      {tab}
                      {activeSubTab === tab && (
              ...
              <div className="space-y-2">
                <span className="text-[11px] text-dark/60 uppercase font-bold tracking-wider">Tech Stack Deployment</span>
              ...
              <div className="border-l-2 border-primaryGreen pl-6 py-2 bg-secondaryBg/40 pr-4 rounded-r-xl">
                ...
                <div className="mt-3">
                  ...
                  <span className="text-[10px] uppercase text-dark/60 tracking-wider font-semibold">{activeProject.review.role}</span>
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                {activeProject.links.demo && (
                  <a href={activeProject.links.demo} className="btn-primary flex items-center gap-2">
                    View Live Work
                    <ArrowUpRight className="w-4 h-4" />
                  </a>
                )}
                {activeProject.links.github && (
                  <a href={activeProject.links.github} className="btn-secondary flex items-center gap-2">
                  ...
                  <DeviceMockup type="macbook">
                    <div className="p-4 bg-secondaryBg flex-1 flex flex-col justify-between text-dark">
                      <div className="flex justify-between items-center border-b border-black/5 pb-2">
                        <span className="text-[8px] font-bold uppercase tracking-wider text-dark/70 flex items-center gap-1">
                      ...
                      <div className="flex-1 flex flex-col justify-end mt-4">
                        ...
                        <div className="flex justify-between text-[6px] text-dark/60 uppercase mt-2 pt-2 border-t border-black/5 font-semibold">
                          <span>Jan</span>
                          <span>Feb</span>
                          <span>Mar</span>
                          <span>Apr</span>
                  ...
                  <DeviceMockup type="phone">
                    <div className="p-4 bg-[#0a0b0d] h-full flex flex-col justify-between text-white">
                      ...
                      <div className="flex-grow flex flex-col justify-center items-center py-6">
                        ...
                        <span className="text-[10px] uppercase tracking-widest text-white/60 font-bold">{activeProject.mockup.description}</span>
                      ...
                      <div className="bg-[#151619] p-3 rounded-xl border border-white/5 space-y-2">
                        <div className="flex justify-between items-center">
                          <span className="text-[7px] text-white/60 uppercase font-semibold">Render Pipeline</span>
